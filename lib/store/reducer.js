...
module.exports = (state, action) => {
  ...
  switch (action.type) {
    ...
    case 'SUBSCRIPTIONS_FETCH': return subscriptionsFetch(state, action);
    case 'SUBSCRIPTION_CHANGE': return subscriptionChange(state, action);
...
function subscriptionsFetch(state, { eventState, value = null }) {
  return {
    ...state,
    subscriptions: {
      ...state.subscriptions,
...
function subscriptionChange(state, { channelId, value }) {
  return {
    ...state,
