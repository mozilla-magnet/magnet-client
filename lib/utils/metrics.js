...
MagnetMetrics.prototype.recordLaunch = function() {
  this.metrics.recordEvent('user', 'startup', 'launch', 1);
};

MagnetMetrics.prototype.recordInstall = function() {
  this._recordOnce('user', 'startup', 'installation', 1);
};

MagnetMetrics.prototype.recordSwiped = function() {
  this.metrics.recordEvent('user', 'interaction', 'swiped', 1);
};

MagnetMetrics.prototype.recordExpanded = function() {
  this.metrics.recordEvent('user', 'interaction', 'expanded', 1);
};
