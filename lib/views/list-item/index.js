...
const styles = StyleSheet.create({
  ...
  content: {
    ...
    paddingBottom: MARGIN_HORIZONTAL,

    // This seems to be required to make
    // sure taps register on embed tiles,
    // not sure why?! Needs deeper look.
    // ISSUE: https://github.com/mozilla-magnet/magnet-client/issues/146
