...
class ItemDetail extends Component {
  ...
  /**
   * Visit the URL. Depending on the URL
   * and the native apps installed on the
   * device, this can open the browser or
   * a specific application.
   *
   * We always visit the shortened URL so that
   * we're able to collect telemetry via
   * magnet-service.
   */
  visitWebsite() {
    ...
    return (
      <View style={styles.distance}>
        <Image
          ...
          source={require('../../images/icon-location-marker.png')}/>
      ...
      <View
        ...
        <MapView
          ...
          annotations={[{
            ...
            id: 'marker1',
            annotationImage: {
              source: resolveAssetSource(require('../../images/icon-location-marker.png')),
              height: 24,
              width: 24,
            },
          }]}
